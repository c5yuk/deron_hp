...
$site_top = "http://deronderonderon.com/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "deronderonderon@gmail.com";
...
$require = array('コンタクト内容','お名前','Email','ご用件');
...
homepage: http://deronderonderon.com/
──────────────────────
